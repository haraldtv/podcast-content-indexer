...
from indexer import searchWord
...
if not((len(sys.argv) >= 2)):
    howtouse()
if ((len(sys.argv) == 2) and not( (sys.argv[1] == "index") or (sys.argv[1] == "struct") or (sys.argv[1] == "init") or (sys.argv[1] == "oneline") ) ):
    howtouse()
...
if ((len(sys.argv) == 2) and (sys.argv[1] == "oneline")):
